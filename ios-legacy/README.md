...
IPA, `.github/workflows/build-ios-legacy.yml` akışıyla Theos ve iOS 10.3 SDK kullanılarak armv7 olarak üretilir. IPA imzasız/adhoc çıkar; Sideloadly kurulum sırasında kullanıcının Apple hesabıyla yeniden imzalar.
